...
# Export
st_write(zone, "data/shapes/zones_od.gpkg", append = TRUE)
st_write(dstr, "data/shapes/districts.gpkg", append = TRUE)
st_write(muni, "data/shapes/cities.gpkg", append = TRUE)
st_write(centro_expandido, "data/shapes/cbd.gpkg", append = TRUE)
